...
if __name__ == "__main__":
    ...
    datapath = 'datasets/strawberry_dataset'
    # ------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    #   读取数据集对应的txt
    # ---------------------------#
    with open(os.path.join(datapath, "VOC2007/ImageSets/Segmentation/train.txt"), "r") as f:
        train_lines = f.readlines()
    with open(os.path.join(datapath, "VOC2007/ImageSets/Segmentation/val.txt"), "r") as f:
    ...
    if True:
        ...
        train_dataset = UnetDataset(train_lines, input_shape, num_classes, True, datapath)
        val_dataset = UnetDataset(val_lines, input_shape, num_classes, False, datapath)
